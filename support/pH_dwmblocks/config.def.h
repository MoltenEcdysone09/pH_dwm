...
/*      pathu                           pathc                           interval        signal */
        { PATH("network.sh"),          NULL,                           5,              1},
        { PATH("vol.sh"),               PATH("volume_button.sh"),       60,              1},
        { PATH("backlight.sh"),         NULL,                           60,              2},
        { PATH("memory.sh"),            NULL,                           2,              3},
        { PATH("cpu_temp.sh"),          PATH("cpu_temp_button.sh"),     5,              4},
